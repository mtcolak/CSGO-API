...
export const getBaseWeapons = () => {
    ...
    // Helper function to get glove item data
    const getGloveData = (weaponName) => {
        const item = state.items?.[weaponName];
        return {
            name: item?.item_name ? $t(item.item_name) : null,
            description: item?.item_description ? $t(item.item_description) : null,
        };
    };
    ...
    const baseWeapons = [
        ...
        {
            id: "studded_bloodhound_gloves",
            name: getGloveData("studded_bloodhound_gloves").name,
            description: getGloveData("studded_bloodhound_gloves").description,
            def_index: weaponIDMapping.studded_bloodhound_gloves,
            image:
                cdnImages["econ/weapons/base_weapons/studded_bloodhound_gloves"] ??
                getImageUrl(`econ/weapons/base_weapons/studded_bloodhound_gloves`),
        },
        {
            id: "studded_brokenfang_gloves",
            name: getGloveData("studded_brokenfang_gloves").name,
            description: getGloveData("studded_brokenfang_gloves").description,
            def_index: weaponIDMapping.studded_brokenfang_gloves,
            image:
                cdnImages["econ/weapons/base_weapons/studded_brokenfang_gloves"] ??
                getImageUrl(`econ/weapons/base_weapons/studded_brokenfang_gloves`),
        },
        {
            id: "sporty_gloves",
            name: getGloveData("sporty_gloves").name,
            description: getGloveData("sporty_gloves").description,
            def_index: weaponIDMapping.sporty_gloves,
            image:
                cdnImages["econ/weapons/base_weapons/sporty_gloves"] ??
                getImageUrl(`econ/weapons/base_weapons/sporty_gloves`),
        },
        {
            id: "slick_gloves",
            name: getGloveData("slick_gloves").name,
            description: getGloveData("slick_gloves").description,
            def_index: weaponIDMapping.slick_gloves,
            image:
                cdnImages["econ/weapons/base_weapons/slick_gloves"] ??
                getImageUrl(`econ/weapons/base_weapons/slick_gloves`),
        },
        {
            id: "leather_handwraps",
            name: getGloveData("leather_handwraps").name,
            description: getGloveData("leather_handwraps").description,
            def_index: weaponIDMapping.leather_handwraps,
            image:
                cdnImages["econ/weapons/base_weapons/leather_handwraps"] ??
                getImageUrl(`econ/weapons/base_weapons/leather_handwraps`),
        },
        {
            id: "motorcycle_gloves",
            name: getGloveData("motorcycle_gloves").name,
            description: getGloveData("motorcycle_gloves").description,
            def_index: weaponIDMapping.motorcycle_gloves,
            image:
                cdnImages["econ/weapons/base_weapons/motorcycle_gloves"] ??
                getImageUrl(`econ/weapons/base_weapons/motorcycle_gloves`),
        },
        {
            id: "specialist_gloves",
            name: getGloveData("specialist_gloves").name,
            description: getGloveData("specialist_gloves").description,
            def_index: weaponIDMapping.specialist_gloves,
            image:
                cdnImages["econ/weapons/base_weapons/specialist_gloves"] ??
                getImageUrl(`econ/weapons/base_weapons/specialist_gloves`),
        },
        {
            id: "studded_hydra_gloves",
            name: getGloveData("studded_hydra_gloves").name,
            description: getGloveData("studded_hydra_gloves").description,
            def_index: weaponIDMapping.studded_hydra_gloves,
            image:
                cdnImages["econ/weapons/base_weapons/studded_hydra_gloves"] ??
                getImageUrl(`econ/weapons/base_weapons/studded_hydra_gloves`),
        },
        {
            id: "weapon_ak47",
